                            ...
                            <div class="overflow-hidden ">
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class=" col-span-6 sm:col-span-4">
                                            <label for="edit_sub_category_category_name" class="block text-sm font-medium text-gray-700">Category Name <span class="text-red-600">*</span></label>
                                        ...
                                        <div class=" col-span-6 sm:col-span-4">
                                            <label for="edit_sub_category_sub_category_name" class="block text-sm font-medium text-gray-700">Sub Category name <span class="text-red-600">*</span></label>
