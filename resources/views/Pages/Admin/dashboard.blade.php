            ...
            <div class="flex-1 min-w-0">
                ...
                <div class="mt-1 flex flex-col sm:flex-row sm:flex-wrap sm:mt-0 sm:space-x-6">
                    <div class="mt-2 flex items-center text-sm text-gray-500">
                        <p class="greetings">{{ $dayTerm }}, {{ Auth::user()->name }} |
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-6 gap-4">
                ...
                <div
                    class="col-start-1 col-end-2 px-3 pt-2 bg-white overflow-hidden shadow-md sm:rounded-lg card_border">
                    <p class="title-card">Users</p>
                    <p class="content-card offset-md-1">{{ count($users) }} users</p>
                </div>
                <div
                    class="col-start-2 col-end-3 px-3 pt-2 bg-white overflow-hidden shadow-md sm:rounded-lg card_border">
                    <p class="title-card">New Users</p>
                    <p class="content-card offset-md-1">{{ $new_users }} created acc.</p>
                </div>
                <div
                    class="col-start-3 col-end-4 px-3 pt-2 bg-white overflow-hidden shadow-md sm:rounded-lg card_border">
                    <p class="title-card">Total Products</p>
                    <p class="content-card offset-md-1">{{ $products_count }}</p>
                </div>
                <div
                    class="col-start-4 col-end-5 px-3 pt-2 bg-white overflow-hidden shadow-md sm:rounded-lg card_border">
                ...
                <div
                    class="col-start-5 col-end-6 col-span-2 px-3 pt-2 bg-white overflow-hidden shadow-md sm:rounded-lg card_border">
                ...
                <div
                    class="col-start-6 col-end-7 col-span-2 px-3 pt-2 bg-white overflow-hidden shadow-md sm:rounded-lg card_border">
                    <p class="title-card">Orders to Ship</p>
                    <p class="content-card offset-md-1">{{ $orders_count_ship }}</p>
                </div>
                    ...
                    <div class="popular-items">
                        <ul class="list-decimal list-inside bg-rose-200">
                            ...
                            @forelse ($popular_items as $popular_item)
                                <li>{{ $popular_item->product->product_name }} -
                                    {{ $popular_item->product->product_code }}</li>
