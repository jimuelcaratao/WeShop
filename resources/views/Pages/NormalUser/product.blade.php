<x-normal_user>
    ...
    <div class="bg-white p-5 my-12 w-11/12 mx-auto flex flex-col justify-center items-center">
        ...
        <div class="p-5 w-4/5 border-b border-gray-400 flex flex-col md:flex-row">
            <img src="{{ asset('./img/RAM1.jpg') }}" alt="RAM" class="block h-2/4 w-2/4 md:h-1/4 md:w-1/4 mx-auto">
            <div class="flex flex-col">
                <h1 class="text-2xl md:text-4xl font-bold">HyperX FURY DDR4 RGB</h1>
                ...
                <div class="mt-5 flex flex-row justify-start">
                    ...
                    <p class="font-bold">10 pieces left</p>
                </div>
                <h1 class="mt-5 text-2xl md:text-4xl font-bold text-yellow-600">&#8369; 2,448.00</h1>
            </div>
        </div>
