            ...
            <form action="{{ route('checkout.address') }}" method="POST">
                ...
                @empty(Auth::user()->user_address)
                        ...
                        <div class="mt-4">
                            ...
                            <x-jet-input id="mobile_no" type="text" class="mt-1 block w-full" autocomplete="mobile_no" name="mobile_no" value="{{ old('mobile_no') }}" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-jet-input id="house" type="text" class="mt-1 block w-full" autocomplete="house" name="house" value="{{ old('house') }}" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-jet-input id="city" type="text" class="mt-1 block w-full"  autocomplete="city" name="city" value="{{ old('city') }}"/>
                        ...
                        <div class="mt-4">
                            ...
                            <x-jet-input id="province" type="text" class="mt-1 block w-full" autocomplete="province" name="province" value="{{ old('province') }}" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-jet-input id="barangay" type="text" class="mt-1 block w-full" autocomplete="barangay" name="barangay" value="{{ old('barangay') }}"/>
                ...
                <div class="flex flex-col md:flex-row p-2 border-b border-gray-300">
                    ...
                    <div class="px-4 w-full flex flex-col justify-center items-start space-y-3">
                        ...
                        @if (!empty($cart->product->product_price->discounted_price))
                            ...
                            <div class="flex flex-row text-sm text-red-600"><span class="line-through">&#8369; @convert(optional($cart->product->product_price)->price)</span>
                                <span>
